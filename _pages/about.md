...
$\quad$ 1. Solving quantum many-body problems, such as finding the system's ground state and simulating its dynamics.<br>
$\quad$ 2. Developing explainable, trustworthy machine learning methods.<br>
$\quad$ 3. Developing efficient methods that search for the quantum circuit architectures.
